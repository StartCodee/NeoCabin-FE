  ...
  return (
    <div style={{ maxWidth: 880, margin: 12, fontFamily: "Inter, Arial, sans-serif" }}>
      ...
      <div style={{ display: "flex", gap: 12 }}>
        <div>
          <div style={{ position: "relative", width: DISPLAY_WIDTH, height: DISPLAY_HEIGHT, background: "#000" }}>
            <video ref={videoRef} width={DISPLAY_WIDTH} height={DISPLAY_HEIGHT} style={{ position: "absolute", left: 0, top: 0 }} muted playsInline />
            <canvas ref={canvasRef} width={DISPLAY_WIDTH} height={DISPLAY_HEIGHT} style={{ position: "absolute", left: 0, top: 0, pointerEvents: "none" }} />
          </div>
